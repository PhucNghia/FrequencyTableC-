...
namespace CS_DL_DPT
{
    public partial class Form : System.Windows.Forms.Form
    {
        ...
        {
            setRowColumnHeader(dgvIn, 6, 6, "input");
            setRowColumnHeader(dgvOut1, 6, 6, "input");
            setRowColumnHeader(dgvOut2, 6, 6, "output");
        ...
        private void btnInRowCol_Click(object sender, EventArgs e)
        {
            ...
            if (check == 1)
            {
                ...
                //{
                    setRowColumnHeader(dgvIn, row, col, "input");
                    setRowColumnHeader(dgvOut1, row, col, "input");
                    setRowColumnHeader(dgvOut2, row, col, "output");
                //}
                //else
                //{
        ...
        private void setRowColumnHeader(DataGridView dgv, int row, int col, string typeTable)
        {
            // Add column header
            try
            {
        ...
        // Set value to Result Table
        private void resultTable(DataGridView dgv, double[][] array)
        {
            int row = dgv.RowCount;
            int column = dgv.ColumnCount;
            for (int i = 0; i < column; i++)
                ...
                {
                    dgv.Rows[i].Cells[j].Style.ForeColor = Color.Black;
                    dgv.Rows[i].Cells[j].Value = array[j][i].ToString();
                }
        }
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            ...
            if (fopen.FileName != "")
            {
                ...
                try
                {
                    ...
                    setRowColumnHeader(dgvIn, rows - 1, cols - 1, "input");   // Phải trừ dòng Header và cột Header ở Excel
                    setRowColumnHeader(dgvOut1, rows - 1, cols - 1, "input");
                    setRowColumnHeader(dgvOut2, rows - 1, cols - 1, "output");
